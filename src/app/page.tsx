...
const projects = [
  ...
  { title: 'Kodo Scholarships', description: 'React JS,Tailwind CSS,Redux,Node JS,Express JS,Mongo DB,Tawk Chatbot,Digital Ocean,Firebase Storage', image: port3, link: 'https://lustrous-jelly-76aaaf.netlify.app/', github: 'https://github.com/Fynn-Emmanuel-Junior/kodo-web' },
