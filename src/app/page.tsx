...
const projects = [
  ...
  { title: 'Kodo Scholarships', description: 'React JS,Tailwind CSS,Redux,Node JS,Express JS,Mongo DB,Tawk Chatbot,Digital Ocean,Firebase Storage', image: port3,link: 'https://www.kodoscholarship.com/',github: 'https://github.com/Fynn-Emmanuel-Junior/kodo-web'},
