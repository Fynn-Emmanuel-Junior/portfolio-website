...
const projects = [
  ...
  { title: 'NextDeal', description: 'Next js, Resend,FastAPI, Micorservice architecture , Tailwind css,Typescript,Framer motion, postgresql', image: port10,link: 'https://next-deal-lime.vercel.app/',github: 'https://github.com/Fynn-Emmanuel-Junior/portfolio-website'},
  ...
  { title: 'Kodo Scholarships', description: 'React JS,Tailwind CSS,Redux,Node JS,Express JS,Mongo DB,Tawk Chatbot,Digital Ocean,Firebase Storage', image: port3,link: 'https://kodo-web.vercel.app/',github: 'https://github.com/Fynn-Emmanuel-Junior/kodo-web'},
                        ...
                        <a href={project.link} key={project.title} className="px-2 cursor-pointer md:px-4 h-64 w-full">
                            <div className="bg-white w-full text-gray-800 rounded-lg shadow-lg overflow-hidden group border border-gray-700 hover:-translate-y-2 transition-transform duration-300 h-full flex flex-col">
                                ...
                                <div className="p-6 cursor-pointer flex flex-col flex-grow">
                                    <h3 className="text-[12px]  md:text-xl font-bold text-gray-800 mb-2">{project.title}</h3>
